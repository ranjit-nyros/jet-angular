...
@Component({
    ...
    <div (mouseenter)="pause()" (mouseleave)="play()" class="carousel slide">
      ...
      <a class="left carousel-control" (click)="prev()" [hidden]="!slides.length" style="color:red;"><i class="glyphicon glyphicon-triangle-left"></i></a>
         <li *ngFor="let slidez of slides" [class.active]="slidez.active === true" (click)="select(slidez)" style="background-color:#306FAA;"></li>
         <a class="right carousel-control" (click)="next()" [hidden]="!slides.length" style="color:red;"><i class="glyphicon glyphicon-triangle-right"></i></a>
      </ol>
